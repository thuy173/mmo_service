...
import TableRowComponent from '../AccountAvailableRow';
import { fetchAccountAvailable } from 'src/store/apps/account/AccountSlice';
import { AccountResponseDto } from 'src/types/apps/account';
import { Link as RouterLink } from 'react-router-dom';
import { useTranslation } from 'react-i18next';

const AccountAvailableView: React.FC = () => {
  ...
  useEffect(() => {
    dispatch(fetchAccountAvailable(searchTerm, page, rowsPerPage, orderBy, order.toUpperCase()));
...
export default AccountAvailableView;
